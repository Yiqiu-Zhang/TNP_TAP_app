...
setup(
    name = "theraprofnano",
      ...
      packages = [
          ...
          "theraprofnano.Plotters",                                  # For plotting graphs for the web front.
          "theraprofnano.TAP",                                       # Therapeutic Antibody Profiler (VH+VL)
          "scripts"
      ],
      package_dir = {
          ...
          "theraprofnano.TAP": "lib/python/theraprofnano/TAP"
      },
      package_data = {
          "theraprofnano.Hydrophobicity_and_Charge_Profiler": [ "dat/*" ],
      },
      scripts = ["bin/TNP", "bin/TAP"], #, "bin/psa", "bin/psa_mac"],
